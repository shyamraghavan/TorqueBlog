(function($) {
  ...
  var LunrSearch = (function() {
    ...
    LunrSearch.prototype.compileTemplate = function($template) {      
      return function(data) {
        return Mustache.render($template.text(), data);
      };
    };
  ...
  $.fn.lunrSearch.defaults = {
    indexUrl  : '/json/search.json',     // Url for the .json file containing search index source data (containing: title, url, date, body)
